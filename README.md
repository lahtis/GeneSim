<h1>🚀 What’s Actually New in v1.3.0?</h2>
...
While the demo focused on "looking good" in the console, v1.3.0 focuses on Data Portability.
...
The demo had "Period-Specific Realism," but v1.3.0 adds Logical Realism.
...
The demo was a character creator. Version 1.3.0 is a data engine. You have moved from a tool that shows you a name to a tool that delivers a validated, reproducible, and structured dataset.
...
<li>Version: v1.3.0 (Development stage).</li>
